...
static const Rule rules[] = {
	...
	{ "torbrowser-launcher", "torbrowser-launcher", NULL, 0,        0,          0,          1,         -1 },
...
/* button commands */
static const char *scratch_cmd[]   = {"st", "-c", "dropdown", NULL};
static const char *powerctl_cmd[]  = {"powermanager", NULL};
static const char *dmenu_run_cmd[] = {"dmenu_run", NULL};
...
static Button buttons[] = {
	...
	{ ClkWinTitle,          0,              Button2,        spawn,          {.v = powerctl_cmd  } },
	{ ClkWinTitle,          0,              Button3,        spawn,          {.v = scratch_cmd   } },
	{ ClkWinTitle,          ShiftMask,      Button3,        spawn,          {.v = dmenu_run_cmd } },
