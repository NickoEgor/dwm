...
static const char selbgcolor[]            = "#660066";
...
static Button buttons[] = {
	...
	/* { ClkStatusText,        0,              Button1,        dwmbarcommand,  {.i = 1 } }, */
	/* { ClkStatusText,        0,              Button2,        dwmbarcommand,  {.i = 2 } }, */
	/* { ClkStatusText,        0,              Button3,        dwmbarcommand,  {.i = 3 } }, */
	/* { ClkStatusText,        0,              Button4,        dwmbarcommand,  {.i = 4 } }, */
	/* { ClkStatusText,        0,              Button5,        dwmbarcommand,  {.i = 5 } }, */
